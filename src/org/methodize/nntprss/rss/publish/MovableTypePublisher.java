 ...
 * @version $Id: MovableTypePublisher.java,v 1.1 2003/05/05 02:20:13 jasonbrome Exp $
 */
...
public class MovableTypePublisher implements Publisher {
	...
	/**
	 * @see org.methodize.nntprss.rss.publish.Publisher#publish(Map, String)
	 */
	...
	/**
	 * @see org.methodize.nntprss.rss.publish.Publisher#validate(Map)
	 */
